...
(function($){
  ...
  $.fn.mColorPicker.events = function() {
   ...
   /*   try {
    ...
    $('.mColor, .mPastColor').live('mousemove', function(e) {
      ...
      else if ($t.hasClass('mColorTransparent')) $o.color = '';
  ...
  $.fn.mColorPicker.drawPickerTriggers = function () {
    ...
    var $t = $(this),
        ...
        color = $.fn.mColorPicker.setColor($t.css('background-color'), ($t.attr('data-hex') || $t.attr('hex'))),
        width = $t.width(),
        height = $t.height(),
        flt = $t.css('float'),
        $c = $(span),
    ...
    $c.html('').remove();
    $e = $(colorPicker).attr('id', id).addClass('mColorPicker').insertBefore($trigger);
  ...
  $.fn.mColorPicker.colorPicked = function () {
    ...
    $o.currentInput.trigger('colorpicked',[$mColorPickerInput.val()]);
  };
  ...
  $.fn.mColorPicker.addToSwatch = function (color) {
    ...
    var $inSwatch = false;
		$('.mPastColor').each(function() {
			if ($o.color == "" || $o.color == $.fn.mColorPicker.RGBtoHex($(this).css('background-color'))) $inSwatch = true;
    });
    if (!$inSwatch) {
