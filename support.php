...
<hr />
<h3>Template</h3>
<p>Todo: Dwoo Template explanation</p>
<p><strong>Post  (=event detail page)</strong> <br />
  The post template field may contain text, HTML, droplets and the special ProCalendar tags: [EVENT_TITLE], [DATE_FULL], [EVENTTYPE], [CUSTOM1], [CUSTOM2], [CUSTOM3], [CUSTOM4], [CUSTOM5], [CUSTOM6], [CATEGORY], [CONTENT], and [BACK]. You are free to use or delete tags or move them around. The default post template is:</p>
